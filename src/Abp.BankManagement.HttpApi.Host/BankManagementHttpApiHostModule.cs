...
namespace Abp.BankManagement
{
    ...
    public class BankManagementHttpApiHostModule : AbpModule
    {
        ...
        private void ConfigureVirtualFileSystem(ServiceConfigurationContext context)
        {
            ...
            // Sadece local geliþtirme + konteyner dýþý ortamda fiziki projelere bak
            if (env.IsDevelopment() && !inContainer)
            {
        ...
        private static void ConfigureSwaggerServices(ServiceConfigurationContext context, IConfiguration configuration)
        {
            context.Services.AddAbpSwaggerGenWithOAuth(
                ...
                options =>
                {
                    ...
                    options.DocInclusionPredicate((docName, description) => !description.RelativePath!.StartsWith("api/abp/"));
